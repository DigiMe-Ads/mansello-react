...
const cards: ServiceCard[] = [
  ...
  },
  {
    ...
    description:
      "Day trips and multi-day transport tailored to your itinerary - Negombo, Kandy, Ella, Galle and beyond. Tell us your plan and we'll quote a fair price.",
  },
];
  ...
  return (
    <section className="relative bg-[#0E4A49] px-6 pt-20 sm:px-12 lg:px-20">
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        {/* Pill-shaped garden photo strip, aligned right with half of it bleeding below the section */}
