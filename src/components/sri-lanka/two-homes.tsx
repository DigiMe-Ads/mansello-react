      ...
      <div className="mx-auto grid max-w-6xl items-center gap-16 lg:grid-cols-[380px_1fr]">
        ...
        <div className="relative">
          ...
          <p className="mt-5 text-sm leading-relaxed text-slate-500 sm:text-base">
            Mansello began with a simple belief: travel feels better when someone is 
            genuinely expecting you. What started as a family opening its doors to 
            guests has grown into two hospitality stays nearly 8,000 km apart — Dona&apos;s 
            Villa on Sri Lanka&apos;s western coast, and The Nest Bologna in northern Italy — 
            connected by the same standard of care.
          </p>

          <p className="mt-4 text-sm leading-relaxed text-slate-500 sm:text-base">
            Whichever Mansello you stay at, you&apos;ll find the same things waiting: a 
            clean and comfortable room, honest prices, and hosts who know the area inside out.
          </p>
