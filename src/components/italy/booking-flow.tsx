...
const steps = [
  {
    image: "/images/italy/nest-bologna/nest-bologna-hallway-1.webp",
    alt: "Entrance hallway leading into The Nest Bologna",
    title: "Choose How to Book",
    description: "Standalone, or added to your stay.",
    cta: { label: "Book a Stay", href: "/italy/airbnb", external: false },
  },
  {
    image: "/images/italy/nest-bologna/nest-bologna-dining-room-1.webp",
    alt: "Dining corner at The Nest Bologna",
    title: "Share Your Details",
    description: "Transfer type, date, flight & passengers.",
    cta: { label: "Request a Transfer", href: "/italy/transport#transfer-request", external: false },
  },
  {
    image: "/images/italy/nest-bologna/nest-bologna-entrance-1.webp",
    alt: "Front door of The Nest Bologna",
    title: "Get Confirmed",
    description: "Email confirmation, driver details on WhatsApp.",
    cta: { label: "Chat on WhatsApp", href: "https://wa.me/393803488663", external: true },
  },
];
